...
main_path = os.path.abspath('/Users/cedelmaier/Projects/Biophysics/septin_project/atomistic/simulations/data/enhanced_sampling/metadynamics/unbias_charge')
...
plot_fes(dz_adjusted, alpha_adjusted, fes_adjusted, "charged_fes_adjusted.pdf")
...
plot_fes(dz_biased_adj, alpha_biased_adj, fes_biased_adj, "charged_fes_biasedadjusted.pdf")
...
plot_fes(dz_biased_as_adj, alpha_biased_as_adj, fes_biased_as_adj, "charged_fes_as_biasedadjusted.pdf")
