...
//! Pair potential force compute for GrimeLipid forces
typedef PotentialPair<EvaluatorPairGrimeLipid> PotentialPairGrimeLipid;
//! Pair potential force compute for BornMayerHuggins forces
typedef PotentialPair<EvaluatorPairBornMayerHuggins> PotentialPairBornMayerHuggins;
